        ...
        <div className="mt-14 grid gap-10 border-t border-cream/15 pt-12 md:grid-cols-[1.4fr_1fr_1fr_1.2fr]">
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2.5 text-sm text-cream/80">
              ...
              <li><Link className="transition hover:text-blush-deep" href="/policies#shipping">Shipping & delivery</Link></li>
              <li><Link className="transition hover:text-blush-deep" href="/policies#returns">Returns & refunds</Link></li>
              <li><Link className="transition hover:text-blush-deep" href="/policies#privacy">Privacy policy</Link></li>
              <li><Link className="transition hover:text-blush-deep" href="/policies#terms">Terms of sale</Link></li>
