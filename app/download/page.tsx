...
// ALWAYS self-hosted: the old GitHub-Releases fallback 404ed and browsers saved the
// error page as a fake few-KB "tajgifts.apk" (=> "app not installed"). Never again.
const APK_URL = process.env.NEXT_PUBLIC_APK_URL || "/tajgifts.apk?v=2";
const APK_VERSION = "v3 (1.2.0)";
const APK_SIZE = "173 KB";
const APK_SHA256 = process.env.NEXT_PUBLIC_APK_SHA256 || "25e296d6036cf9ca6313a45a241567786a26fccb4bbace701b3b8cc3a559093b";
          ...
          <div>
            ...
            <div className="mt-8 max-w-md space-y-3">
              ...
              <a href={APK_URL} className="btn-ghost w-full justify-center py-4 text-[12px]" download>
                🤖 Download Android APK {APK_VERSION} (free)
              </a>
              <p className="text-center text-[12px] text-ink-soft">
                APK = the same app as a file for any Android phone · or use the instant install above (recommended)
              </p>
              <p className="text-center font-mono text-[10px] leading-relaxed text-ink-soft/80">
                {APK_VERSION} · {APK_SIZE} · signature-verified · SHA-256 {APK_SHA256.slice(0, 16)}…
                <br />
                File under 100 KB won’t install or says “app not installed”? That is an old broken download —
                delete it and download fresh from this page.
              </p>
            </div>
